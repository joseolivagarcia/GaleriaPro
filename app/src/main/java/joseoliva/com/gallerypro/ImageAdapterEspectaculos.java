...
public class ImageAdapterEspectaculos extends PagerAdapter {

    private TypedArray images;
    private LayoutInflater layoutInflater;

    public ImageAdapterEspectaculos(Context context){

        images = context.getResources().obtainTypedArray(R.array.espectaculoslImages);
