...
public class ImageAdapterCurri extends PagerAdapter {

    private TypedArray images;
    private LayoutInflater layoutInflater;

    public ImageAdapterCurri(Context context){

        images = context.getResources().obtainTypedArray(R.array.curriImages);
