...
public class ImageAdapterPhotocall extends PagerAdapter {

    private TypedArray images;
    private LayoutInflater layoutInflater;

    public ImageAdapterPhotocall(Context context){

        images = context.getResources().obtainTypedArray(R.array.photocallImages);
